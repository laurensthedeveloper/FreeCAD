    ...
    const QString sheet =
        (QStringLiteral("#RibbonBar { background: %1; }"
         ...
         + QStringLiteral(
             ...
             "#RibbonQuickAccessButton { border: none; border-radius: 5px; padding: 0px;"
             "  background: transparent; }"
             "#RibbonQuickAccessButton:hover { background: %3; }"
             "#RibbonQuickAccessSeparator { background: rgba(128, 128, 128, 110); border: none; }"
             "#RibbonWindowTitle { color: %7; }"
             "#RibbonSearch { border: 1px solid rgba(128, 128, 128, 80); border-radius: 5px;"
             "  padding: 2px 4px; background: %6; color: %7; }"
